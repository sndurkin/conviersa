...
void IrcChanTopicDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option,
...
QSize IrcChanTopicDelegate::sizeHint(const QStyleOptionViewItem &option,
					const QModelIndex &index) const
{
